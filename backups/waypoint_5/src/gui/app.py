...
class EyeTrackingApp(ctk.CTk):
    ...
    def _setup_ui(self):
        ...
        self.momentum_label.pack(padx=10, pady=(10, 0))
        ...
        self.vertical_sens_label.pack(padx=10, pady=(10, 0))
    ...
    def _update_momentum(self, value):
        ...
        self.mouse_controller.set_momentum(float(value))
        
    def _update_vertical_sensitivity(self, value):
        """Update vertical sensitivity factor"""
        self.mouse_controller.set_vertical_sensitivity(float(value))
