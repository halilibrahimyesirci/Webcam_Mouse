        ...
        while self.is_tracking:
            ...
            if ret:
                ...
                if tracking_result:
                    ...
                    # Merkez noktasını çiz (gerçek fare pozisyonu)
                    ...
                    if self.mouse_control_enabled:
                        ...
                        if screen_pos is not None:
                            # İris metrikleri ile hassasiyet ayarı
                            confidence = (left_metrics['regularity'] + right_metrics['regularity']) / 2
                            if confidence > 0.7:  # Yüksek güvenilirlik
